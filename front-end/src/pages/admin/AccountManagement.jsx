    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
        {[
          ...
          {
            title: "Đang Thuê",
            value: tenants.filter((t) => t.status === "Đang thuê").length,
          },
          {
            title: "Đã trả phòng",
            value: tenants.filter((t) => t.status === "Đã trả phòng").length,
          },
          {
            title: "Chưa thuê",
            value: tenants.filter((t) => t.status === "Chưa thuê").length,
          },
        ].map((stat, index) => (
          <div
            key={index}
                ...
                currentData.map((tenant) => (
                  ...
                  >
                    ...
                    <td className="p-3 flex justify-center gap-2">
                      ...
                      <button className="p-1.5 border rounded hover:bg-red-50 text-red-500">
                        <FaTrashAlt size={12} />
                      </button>
                    </td>
                  </tr>
